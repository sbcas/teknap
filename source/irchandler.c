...
/*			"50: 57s-1ignon   50:-1 $0-"*/
		...
		case 333: /* topic time */
			break;
#if 0
ùíù Numbered server stuff: "352 pana #opennap toasty bender.thirty4.com irc.lightning.net Toasty_ H@ :2 Chad Boyda" (irc.core.com)
ùíù Numbered server stuff: "315 pana #opennap :End of /WHO list." (irc.core.com)
#endif
		case 315:
			break;
		case 352:
