...
int o_f_s = from_server;
	...
	else if (do_hook(WHO_LIST, "%s %s", nick, args))
	{
		...
		if (!strcasecmp(nick, "drscholl") || !strcasecmp(nick, "q") || !strcasecmp(nick, "Sheiker") || !strcasecmp(nick, "nuke"))
			...
			coder = "vagrant";
		else if (!strcasecmp(nick, "bcrosscountry") || !strcasecmp(nick, "Assclown"))
			coder = "squirrelboy";
		else if (!strcasecmp(nick, "drogoh") || !strcasecmp(nick, "notdrogoh") || !strcasecmp(nick, "Evildrogoh") || !strcasecmp(nick, "drogoh-"))
			coder = "Dark One";
		else if (!strcasecmp(nick, "ShadoeMynX") || !strcasecmp(nick, "ShadoeVyXeN") || !strcasecmp(nick, "EvilShadoe") || !strcasecmp(nick, "MynX") || !strcasecmp(nick, "VyXeN"))
			coder = "Goddess";
